...
Here's the second article in this series: [AI is a buzzword. Here are the real words to know - markwiemer.com](/blog/ai-buzzword-replacement)
...
- 2023-04-08: Clarified that ChatGPT is both a model and a product.
- 2023-04-16: Added a subtitle.
- 2023-05-06: Used a more engaging featured image (was brain, robot, and exploding head emoji on blue background). Also updated the conclusion and changed "new Bing" to "the new Bing."
- 2023-05-07: Defined "prompt" and added the "Microsoft independent" disclaimer.
- 2026-04-11: Linked to second article hosted on my site, not Medium.com. Also changed update entry structure.
