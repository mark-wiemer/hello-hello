---
postTitle: Who am I, anyway? A 5-minute autobiography
postDate: "2023-04-17"
original: "https://markwiemer.medium.com/who-am-i-anyway-a-5-minute-autobiography-f46fb3e6ead4"
---

import Layout from "@/layouts/Layout.astro";
import CaptionedImage from "@/components/CaptionedImage.astro";
import Baby from "@/assets/1999-XX-XX Mark baby picture.webp";
import PizzaArmor from "@/assets/20XX-XX-XX pizza box armor.webp";
import ForensicsTrophy from "@/assets/2014-XX-XX forensics trophy pose.webp";
import Headshot2020 from "@/assets/2020-02-01 profile picture blue shirt green background.webp";
...
<CaptionedImage src={Baby} alt="Me as a cute baby" eager />
...
{/* prettier-ignore */}
<CaptionedImage src={PizzaArmor} alt="Me showing off my pizza box armor">(She's been emojified because she's not the main character. Also, privacy)</CaptionedImage>
...
<CaptionedImage src={ForensicsTrophy} alt="Me posing with my high school forensics trophy" />

After the girl I loved found someone else, your 18-year-old author started dating someone who ended up raping him. That was not fun. We broke up.
...
{/* prettier-ignore */}
<p><small>\*OK, she said "I dated a lot of girls," but that doesn't lend itself as well to my pun.</small></p>
...
{/* prettier-ignore */}
<CaptionedImage src={Headshot2020} alt="Me, looking professional in February 2020">I like this shirt because it's full of equal signs. It covers my love of math and social justice! 🤓</CaptionedImage>
...
- 2026-02-18: The earlier version of this article implied I was 16 when I was first sexually assaulted. I've clarified that this didn't happen until I was 18.
- 2026-04-13: Aligned look and feel with other blog posts. [Link back to Medium]() will return soon.
