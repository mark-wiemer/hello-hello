...
import type { LtPlayer, LtPlayerJoinCallback, LtPlayerLeaveCallback } from "./player";
...
export interface LuantiGlobal {
  ...
  // todo get_meta
  // todo get_node_timer
  add_entity(this: void, pos: LtVec3, name: string, staticdata?: LtEntityStaticData): LtObjRef;
  // todo add_item
  get_player_by_name(this: void, name: string): LtPlayer | undefined;
  get_objects_inside_radius(this: void, pos: LtVec3, radius: number): LtObjRef[];
  ...
  // todo delete_area
  // todo line_of_sight
  raycast(this: void, from: LtVec3, to: LtVec3, objects?: boolean, liquids?: boolean): Raycast;
