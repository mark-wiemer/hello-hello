...
export interface OnDropCallback {
  (this: void, itemstack: LtItemStack, dropper: LtPlayer | undefined, pos: LtVec3): void;
}
...
export interface LtTileAnimVerticalFramesDef extends LtTileAnimDef<"vertical_frames"> {
...
export type LtNodeBoxType = "regular" | "leveled" | "fixed" | "wallmounted" | "connected";
...
export interface LtNodeDef<NodeBoxType extends LtNodeBoxType> extends LtItemDef {
