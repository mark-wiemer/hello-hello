...
namespace SemicolonPlacementAnalyzer
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(SemicolonPlacementAnalyzerCodeFixProvider)), Shared]
    public class SemicolonPlacementAnalyzerCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create(SemicolonPlacementAnalyzerAnalyzer.DiagnosticId);
