...
namespace SemicolonPlacement
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(SemicolonPlacementCodeFixProvider)), Shared]
    public class SemicolonPlacementCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create(SemicolonPlacementAnalyzer.DiagnosticId);
