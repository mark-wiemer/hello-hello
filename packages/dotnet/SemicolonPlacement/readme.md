...
1. Name it `SemicolonPlacement`. Do not include `Analyzer` in the name.
...
- Add common files:
  ...
  - `.gitignore`
  - `readme.md`
- Add those files to the solution:
  - Visual Studio
  - Solution Explorer
  - Solution name
  ...
  - `slnx` file should update
- Format (via Visual Studio code cleanup)
