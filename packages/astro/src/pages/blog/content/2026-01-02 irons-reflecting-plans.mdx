...
import BlacksmithImage from "@/assets/Blacksmith in the Goldfields by Felix Octavius Carr Darley from nga.gov.jpg";
...
<CustomImage
  ...
  caption="Blacksmith in the Goldfields by Felix Octavius Carr Darley from the National Gallery of Art"
/>
