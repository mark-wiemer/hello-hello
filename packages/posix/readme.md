...
POSIX also defines the [Shell Command Language](https://pubs.opengroup.org/onlinepubs/9799919799/utilities/V3_chap02.html) that handles parsing and executing commands.

- [POSIX - Wikipedia](https://en.wikipedia.org/wiki/POSIX)
- [Shell and Utilities section of POSIX](https://pubs.opengroup.org/onlinepubs/9799919799/utilities/contents.html)
